...
Automatizar reset, checkpoints y cues para que una persona maneje el frontend mientras dos incidentes simulados llegan mediante runs HappyRobot. Incluye un modo API de respaldo etiquetado.
