...
- [ ] T38: emite `estimatedCost` independiente de `decision`; nunca escala por importe. Solo una elección operativa explícita puede generar `decision.kind: operational`.
