...
- [x] T37 sustituye el escalado económico: el coste no bloquea el plan, la previsión no compromete dinero y solo las decisiones operativas explícitas requieren al responsable.
