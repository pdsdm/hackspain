...
| T40 | Cierre de la crisis: los acuerdos avanzan, el plan termina (cerrado o incompleto) y la intervención humana no espera a la cola | Ventura | `fix/ventura-cierre-demo` | [Contrato](docs/api-contract.md#cierre-de-la-crisis-resolved-closuresummary-coordinatorstatus-atascado) | review |
